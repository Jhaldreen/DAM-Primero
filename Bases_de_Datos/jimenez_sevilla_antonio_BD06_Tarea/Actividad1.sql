/*
		ACTIVIDAD 1 - CREACIÓN DE UN PROCEDIMIENTO
*/
CREATE OR REPLACE
...
--FUNCIÓN QUE COMPRUEBA SI LA FAMILIA DESTINO ES HIJA DE LA FAMILIA ORIGEN
		...
		IF (PADRE IS NULL) OR (PADRE = ID_F_DESTINO) THEN
...
ELSE
 ...
 --CONTINÚO CON EL PROCESO
	...
	UPDATE FAMILIAS SET FAMILIA = ID_FAMILIA_DESTINO,
	OFICINA = NULL WHERE IDENTIFICADOR = ID_FAMILIA_ORIGEN;
	COMMIT;
	ELSE
	DBMS_OUTPUT.PUT_LINE('NO SE REALIZA EL PROCESO DE REASIGNACIÓN, YA QUE LA FAMILIA DESTINO ES PADRE DE LA ORIGEN.');
